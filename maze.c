 ...
 void frontscreen(void)
{
    ...
    glColor3f(1,1,1);
	output(25,160," ST JOSEPH ENGINEERING COLLEGE,MANGALURU");
	glColor3f(1,1,1);
	output(15.0,150,"DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING");
	glColor3f(1,0,1);
	output(50,130,"A Mini Project On");
	glColor3f(0,1,0.5);
	output(38,120,"\"MAZE GAME USING OPENGL\"");
	glColor3f(1,0,1);
	output(40,100,"By:");
	glColor3f(1,0,0);
	output(40,90,"Navyashree-4SO20CS093 & Maria Viola Rodrigues-4SO20CS082");
	...
	glColor3f(1,0,0);
	output(70,40,"Mr.Anirudhan AdukkathayarC,Dept. of CSE");
	glColor3f(1,0,0);
	output(40,30,"");
	glColor3f(1,0,0);
	drawstring(72,30," ",GLUT_BITMAP_HELVETICA_12);

	output(70,30,"Ms.Anusha,Dept. of CSE");
	glFlush();
